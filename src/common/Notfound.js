                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="d-flex justify-content-center mt-3">
                                <button className="text-uppercase fw-bold px-sm-5 px-2 py-1 btn1" onClick={() => navigate("/")}>back to home</button>
                                <button className="text-uppercase fw-bold px-sm-5 px-2 py-1 btn2" onClick={() => navigate(-1)}>go back</button>
                            </div>
                        </div>
                    </div>
                </div>
